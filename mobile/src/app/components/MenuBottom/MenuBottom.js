...
const getBottomStackIcon = routeName => bottomStackIconList[routeName] || 'x-square';
...
const MenuBottom = props => {
  ...
  const menuItems = props.props.navigation.state.routes.filter(route => bottomTabRouteList.includes(route.routeName));

  log('MenuBottom', 'currentRouteName', currentRouteName, 'menuItems', menuItems);
      ...
      {menuItems.map(route => (
        ...
        >
          <Icon
            ...
            size={18}
            color={currentRouteName === route.routeName ? props.props.activeTintColor : props.props.inactiveTintColor}
          />
          <Text style={{
            color: currentRouteName === route.routeName ? props.props.activeTintColor : props.props.inactiveTintColor,
            fontSize: 11,
